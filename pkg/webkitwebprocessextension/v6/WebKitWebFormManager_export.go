...
//export _gotk4_webkitwebprocessextension6_WebFormManager_ConnectWillSendSubmitEvent
func _gotk4_webkitwebprocessextension6_WebFormManager_ConnectWillSendSubmitEvent(arg0 C.gpointer, arg1 *C.JSCValue, arg2 *C.WebKitFrame, arg3 *C.WebKitFrame, arg4 C.guintptr) {
...
//export _gotk4_webkitwebprocessextension6_WebFormManager_ConnectWillSubmitForm
func _gotk4_webkitwebprocessextension6_WebFormManager_ConnectWillSubmitForm(arg0 C.gpointer, arg1 *C.JSCValue, arg2 *C.WebKitFrame, arg3 *C.WebKitFrame, arg4 C.guintptr) {
	var f func(form *javascriptcore.Value, sourceFrame, targetFrame *Frame)
	{
		closure := coreglib.ConnectedGeneratedClosure(uintptr(arg4))
		if closure == nil {
